<#
.SYNOPSIS
    Runs import init-lcm.xml in IIQ Console

.DESCRIPTION
    Opens IIQ console and automatically runs "import init-lcm.xml"
...
# ============================================================================
Clear-Host
Write-Header "IMPORT INIT-LCM.XML"
...
# Run import init-lcm.xml
Write-Host "  Running: import init-lcm.xml" -ForegroundColor Cyan
